...
export default function Navbar({ current_page }){
    ...
    return ( current_page === "home" ? <></> : <>
        ...
        <div className='fixed top-0 left-0 z-20 flex flex-col bg-[#ffffffaa] h-16 md:bg-[#ffffff00] md:flex-row md:justify-between md:items-center w-full px-5'
        style={{
        ...
        >
            ...
            >
                <ListOfPages current_page={current_page} />
            </ul>
...
export function ListOfPages({ current_page='' }){
